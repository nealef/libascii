...
wchar_t *	__getAwstring1_a(const wchar_t *);
wchar_t *	__getAwstring2_a(const wchar_t *);
wchar_t *	__getEwstring1_a(const wchar_t *);
wchar_t *	__getEwstring2_a(const wchar_t *);
wchar_t *	__getEwstring3_a(const wchar_t *);
wchar_t *	__getEwstring4_a(const wchar_t *);
void 		__towascii_a(wchar_t *, const wchar_t *);
void 		__towasciilen_a(wchar_t *, const wchar_t *, int);
void 		__towebcdic_a(wchar_t *, const wchar_t *);
void 		__panic_a(char *);
